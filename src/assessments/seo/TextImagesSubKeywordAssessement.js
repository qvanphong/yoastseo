...
export default class TextImagesSubKeywordAssessment extends Assessment {
  /**
  ...
  getResult(paper, researcher, i18n) {
    ...
    this.altProperties = researcher.getResearch('subKeywordImage')
  ...
  hasTooFewMatches() {
    return (
      this.imageCount > 4 &&
      this.altProperties.withAltKeyword > 0 &&
  ...
  hasGoodNumberOfMatches() {
    return (
      (this.imageCount < 5 && this.altProperties.withAltKeyword > 0) ||
      ...
      (this.imageCount > 4 &&
        inRangeStartEndInclusive(
          ...
          this._minNumberOfKeywordMatches,
    ...
    if (this.imageCount === 0) {
      return {
        ...
        resultText: i18n.sprintf(
          ...
          i18n.dgettext(
            'js-text-analysis',
            '%1$sKeyword phụ trong thuộc tính alt%3$s: No images appear on this page. %2$sAdd some%3$s!'
          ),
    ...
    if (this.altProperties.withAlt > 0) {
      return {
        ...
        resultText: i18n.sprintf(
          ...
          i18n.dgettext(
            'js-text-analysis',
            '%1$sKeyword phụ trong thuộc tính alt%3$s: ' +
    ...
    if (this.hasTooFewMatches()) {
      return {
        ...
        resultText: i18n.sprintf(
          ...
          i18n.dngettext(
            'js-text-analysis',
            '%3$sKeyword phụ trong thuộc tính alt%5$s: Out of %2$d images on this page, only %1$d has an alt attribute that ' +
              'reflects the topic of your text. ' +
              '%4$sAdd your keyphrase or synonyms to the alt tags of more relevant images%5$s!',
            '%3$sKeyword phụ trong thuộc tính alt%5$s: Out of %2$d images on this page, only %1$d have alt attributes that ' +
    ...
    if (this.hasGoodNumberOfMatches()) {
      return {
        ...
        resultText: i18n.sprintf(
          ...
          i18n.dgettext('js-text-analysis', '%1$sKeyword phụ trong thuộc tính alt%2$s: Good job!'),
          this._config.urlTitle,
          '</a>'
        ),
      }
    ...
    if (this.hasTooManyMatches()) {
      return {
        ...
        resultText: i18n.sprintf(
          ...
          i18n.dgettext(
            'js-text-analysis',
            '%3$sKeyword phụ trong thuộc tính alt%5$s: Out of %2$d images on this page, %1$d have alt attributes with ' +
